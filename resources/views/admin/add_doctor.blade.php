...
@section('admin-content')
    <form action="{{ url('save_doctor') }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="d-flex mb-4">
            ...
            <input type="text" value="{{ old('name') }}" name="name" class="col-10 text-white bg-dark" id="name"
        ...
        <div class="d-flex mb-4">
            ...
            <input type="text" value="{{ old('phone') }}" name="phone" class="col-10 text-white bg-dark"
        ...
        <div class="d-flex mb-4">
            ...
            <input type="text" value="{{ old('roomnum') }}" name="roomnum" class="col-10 text-white bg-dark"
